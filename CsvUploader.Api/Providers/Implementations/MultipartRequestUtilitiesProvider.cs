...
{
    public class MultipartRequestUtilitiesProvider : IMultipartRequestUtilitiesProvider
    {
        //My reference: https://github.com/aspnet/Docs/tree/master/aspnetcore/mvc/models/file-uploads/sample/FileUploadSample
        ...
        public MultipartReader CreateMultipartReader(string boundary, Stream stream)
        {
            return new MultipartReader(boundary, stream);
        }
    }
}